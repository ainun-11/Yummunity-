...
const fetchPosts = (page = 1) => fetch(`${process.env.NEXT_PUBLIC_API_URL}posts/?page=${page}`, { cache: 'no-store' }).then(res => res.json())
...
const RecentPosts = () => {
    ...
    return (
        <>
            ...
            <Pagination elemId="recent-posts" data={data.result} count={data.count} page={page} pageHandler={postsPageHandler} />
        </>
    )
}
