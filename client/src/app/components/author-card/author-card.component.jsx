        ...
        <div className={`column is-4-desktop is-6-tablet ${styles.authorBlock}`}>
            <div className={`${styles.authorCard} has-text-centered`}>
                ...
                <Link className="post-count" href={`/authors/${user.id}`}>
                    <span className="text-primary">{user.posts.length}</span> posts by this author
                </Link>
            </div>
        </div>
    )
