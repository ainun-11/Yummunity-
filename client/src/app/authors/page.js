...
const fetchUsers = (page = 1) => fetch(`${process.env.NEXT_PUBLIC_API_URL}users/?page=${page}`).then(res => res.json())
            ...
            <Section sectionType="sm" id="users">
                <Container>
                    <div className="columns is-multiline is-gapless">
                        ...
                        <Pagination elemId="users" data={data.result} count={data.count} page={page} perPage={24} pageHandler={postsPageHandler} />
                    </div>
                </Container>
            </Section>
        </>
