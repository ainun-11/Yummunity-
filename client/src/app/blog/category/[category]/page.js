...
const fetchPosts = (category, page = 1) => fetch(`${process.env.NEXT_PUBLIC_API_URL}posts/category/${category}?page=${page}`, { cache: 'no-store' }).then(res => res.json())
                ...
                <div className="columns is-multiline is-desktop">
                    <div className="column is-8-desktop">
                        <h1 className="h2 mb-5">
                            Showing posts in category <mark>{category}</mark>
                        </h1>
                        ...
                        <Pagination elemId="posts" count={data.count} page={page} pageHandler={postsPageHandler} />
                    </div>
